        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-8">
          <div className="lg:mb-18 mx-auto max-w-3xl text-center">
            <h1 className="text-foreground text-5xl font-bold sm:text-6xl">
              Professional <span className="italic">Curved Glass</span> <span className="text-gradient-primary">Calculator</span>
            </h1>
            <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg leading-8">
              Precise calculations for arc measurements, radius, angles, and weight.
              Design, visualize, and export manufacturing-ready cut sheets in seconds.
            </p>
